...
//----------------Flipcart serach--------------------------
        ...
        driver.findElement(searchTextArea).sendKeys("macbook");
        Thread.sleep(3000);
        List<WebElement> predictionList = driver.findElements(By.xpath("//a[@class='oleBil']/div[2]"));
        System.out.println("List size = " + predictionList.size());

        for (WebElement each : predictionList) {
